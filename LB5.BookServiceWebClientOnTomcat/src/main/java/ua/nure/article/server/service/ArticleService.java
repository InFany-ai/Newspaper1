...
public interface ArticleService {
    ...
    @RequestWrapper(localName = "addArticleTag", targetNamespace = "http://article.nure.ua/server/service", className = "ua.nure.article.server.service.AddArticleTag")
    @ResponseWrapper(localName = "addArticleTagResponse", targetNamespace = "http://article.nure.ua/server/service", className = "ua.nure.article.server.service.AddArticleTagResponse")
    @Action(input = "http://article.nure.ua/server/service/ArticleService/addArticleTagRequest", output = "http://article.nure.ua/server/service/ArticleService/addArticleTagResponse", fault = {
        @FaultAction(className = DAOException_Exception.class, value = "http://article.nure.ua/server/service/ArticleService/addArticleTag/Fault/DAOException")
    })

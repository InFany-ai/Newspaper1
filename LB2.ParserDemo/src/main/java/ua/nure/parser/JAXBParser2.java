...
import ua.nure.article.entity.article.Articles;
...
public class JAXBParser2 {
	...
	public static void main(String[] args) throws JAXBException, FileNotFoundException, SAXException {
		...
		Article article = articles.getArticle().get(0);
...
//		marshaller.setProperty(null, schemaFactory);
		...
		JAXBElement<Article> jarticle = new JAXBElement<>(
				new QName(Const.ARTICLES_NAMESPACE_URI, "article"),
				Article.class, article);
		
		marshaller.marshal(jarticle, new File("oneArticle.xml"));
	}
}
...
public class StaxParser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Article> articles = parser.parse(new FileInputStream(Const.XML_FILE));
        System.out.println("====================================");
        System.out.println("Here is the articles: \n" + articles);
        System.out.println("====================================");
        articles = parser.parse(new FileInputStream(Const.INVALID_XML_FILE));
        System.out.println("====================================");
        System.out.println("Here is the invalid articles: \n" + articles);
        System.out.println("====================================");
    }

    private List<Article> parse(InputStream in) throws XMLStreamException {
